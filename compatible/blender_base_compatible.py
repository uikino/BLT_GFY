...
class Blender_Base_Compatible(object):
    ...
    def __internal_basic_API_CE(self):
        ...
        api_pass = hasattr(bpy, "app") and hasattr(bpy, 'context') and hasattr(bpy, 'props') and hasattr(bpy,
                                                                                                         'types') and hasattr(
            bpy, 'utils')
        if not api_pass:
        ...
        compatibility_table.add_row(['bpy.context.preferences', 'addons', hasattr(bpy.context.preferences, 'addons')])
